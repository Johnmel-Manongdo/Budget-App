package com.example.budgetapp.ui.main.history.edit_entry;
...
import com.example.budgetapp.exceptions.EmptyStringException;
import com.example.budgetapp.exceptions.ZeroBalanceDifferenceException;
...
import com.example.budgetapp.firebase.viewmodel_factories.WalletEntryViewModelFactory;
import com.example.budgetapp.util.CategoriesHelper;
import com.example.budgetapp.models.Category;
import com.example.budgetapp.ui.add_entry.EntryCategoriesAdapter;
import com.example.budgetapp.ui.add_entry.EntryTypeListViewModel;
import com.example.budgetapp.ui.add_entry.EntryTypesAdapter;
...
public class EditWalletEntryActivity extends BaseActivity {
    ...
    public void editWalletEntry(long balanceDifference, Date entryDate, String entryCategory, String entryName) throws EmptyStringException, ZeroBalanceDifferenceException {
        if (balanceDifference == 0) {
            throw new ZeroBalanceDifferenceException("Amount should not be 0");
        }

        if (entryName == null || entryName.length() == 0) {
            throw new EmptyStringException("Name should not be empty");
        }
