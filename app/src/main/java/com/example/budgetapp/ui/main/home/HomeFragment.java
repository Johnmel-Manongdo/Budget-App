package com.example.budgetapp.ui.main.home;
...
import com.example.budgetapp.firebase.models.UserSettings;
import com.example.budgetapp.base.BaseFragment;
import com.example.budgetapp.firebase.viewmodel_factories.WalletEntriesHistoryViewModelFactory;
import com.example.budgetapp.ui.options.CalculatorActivity;
import com.example.budgetapp.util.CalendarHelper;
import com.example.budgetapp.util.CategoriesHelper;
import com.example.budgetapp.models.Category;
import com.example.budgetapp.ui.options.OptionsActivity;
...
import com.example.budgetapp.firebase.viewmodel_factories.TopWalletEntriesViewModelFactory;
import com.example.budgetapp.firebase.models.User;
import com.example.budgetapp.libraries.Gauge;
...
public class HomeFragment extends BaseFragment {
    ...
    private void dataUpdated() {
        ...
        if (user.userSettings.homeCounterType == UserSettings.HOME_COUNTER_TYPE_SHOW_LIMIT) {
            ...
            gaugeLeftLine1TextView.setText("Income");
            gaugeLeftLine2TextView.setVisibility(View.INVISIBLE);
